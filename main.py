...
st.title("Llamaindex Linear and Logistic Regression Helper")
...
set_bg_from_url("https://sp-ao.shortpixel.ai/client/to_auto,q_glossy,ret_img,w_1024/https://pianalytix.com/wp-content/uploads/2020/12/Linear-Regression-Vs-Logistic-Regression-1024x427.jpg", opacity=0.875)